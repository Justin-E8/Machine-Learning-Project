...
def run_upcoming_predictions(
    ...
    *,
    ...
    model, metrics, _ = train_baseline_model(features)
    ...
    if not feature_rows:
        ...
        output = fixture_features[["date", "home_team", "away_team"]].copy()
        ...
        output = output.sort_values(["date", "home_team"]).reset_index(drop=True)
